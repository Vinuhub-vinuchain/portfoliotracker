...
A React-based portfolio tracker for VinuChain, displaying VC (VinuCoin) and ERC-20 tokens with balances, prices, and allocations.

## Features
- Connect MetaMask to VinuChain (Chain ID: 207).
